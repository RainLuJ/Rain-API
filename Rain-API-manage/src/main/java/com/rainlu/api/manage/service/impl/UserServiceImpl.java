...
import com.rainlu.api.common.constant.RedisConstant;
import com.rainlu.api.common.exception.BusinessException;
import com.rainlu.api.common.exception.ThrowUtils;
import com.rainlu.api.common.model.dto.user.UserQueryRequest;
import com.rainlu.api.common.model.dto.user.UserUpdateRequest;
import com.rainlu.api.common.model.entity.SmsMessage;
import com.rainlu.api.common.model.entity.User;
import com.rainlu.api.common.model.enums.UserRoleEnum;
import com.rainlu.api.common.model.vo.LoginUserVO;
import com.rainlu.api.common.model.vo.UserDevKeyVO;
import com.rainlu.api.common.model.vo.UserVO;
import com.rainlu.api.manage.upload.FileUploadUtil;
import com.rainlu.api.common.utils.JwtUtils;
import com.rainlu.api.common.utils.LeakyBucket;
import com.rainlu.api.common.utils.SqlUtils;
import com.rainlu.api.manage.mapper.UserMapper;
...
import static com.rainlu.api.common.constant.RabbitMQConstant.EXCHANGE_SMS_INFORM;
import static com.rainlu.api.common.constant.RabbitMQConstant.ROUTINGKEY_SMS;
import static com.rainlu.api.common.constant.UserConstant.USER_LOGIN_STATE;
import static com.rainlu.api.common.utils.LeakyBucket.loginLeakyBucket;
import static com.rainlu.api.common.utils.LeakyBucket.registerLeakyBucket;
...
//        }
    ...
    public boolean userLogout(HttpServletRequest request, HttpServletResponse response) {
        ...
        for (Cookie cookie : cookies) {
            ...
            if (cookie.getName().equals("token")) {
                ...
                /* 过期Cookie：设置过期时间为0，直接覆盖掉原有的Cookie */
    ...
    public boolean updateUser(UserUpdateRequest userUpdateRequest, HttpServletRequest request) {
        ...
        if (!loginUser.getId().equals(id)) {  // 当前用户不能修改别人的信息
            if (!loginUser.getUserRole().equals(UserRoleEnum.ADMIN.getValue())) {  // 管理员才能修改别人的信息
    ...
    private boolean emailCodeValid(String emailNum, String emailCode) {
        String code = stringRedisTemplate.opsForValue().get(RedisConstant.LOGIN_CODE_PRE + emailNum);
