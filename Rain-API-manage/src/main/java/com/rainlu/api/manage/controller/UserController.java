...
public class UserController {
    ...
    public BaseResponse<Page<UserVO>> listUserByPage(UserQueryRequest userQueryRequest, HttpServletRequest request) {
        ...
        queryWrapper.like(userQueryRequest != null && StringUtils.isNotBlank(userQueryRequest.getPhoneNum()),
                "phone", userQueryRequest.getPhoneNum());
        queryWrapper.ge(StringUtils.isNotBlank(userQueryRequest.getCreateTime()),
                "createTime", userQueryRequest.getCreateTime());
        queryWrapper.ge(StringUtils.isNotBlank(userQueryRequest.getUpdateTime()),
                "phoneNum", userQueryRequest.getUpdateTime());
    ...
    public BaseResponse<Boolean> sendCode(@RequestParam String emailNum, @RequestParam String captchaType) {
        ...
        // TODO ^1[3-9]\d{9}$ 手机号正则表达式
        // TODO ^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$    邮箱正则表达式
